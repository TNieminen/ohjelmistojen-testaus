...
describe('==== clamp ====', () => {
  ...
  it('Should lower a number higher than the higher limit, to the higher limit',() => {
    expect(clamp(10, -5, 5)).toEqual(5)
  })

  // Related issue https://github.com/TNieminen/ohjelmistojen-testaus/issues/14
  it('Should keep its own value if already between limits on positive side',() => {
    expect(clamp(1, -5, 5)).toEqual(1)
  })

  // Related issue https://github.com/TNieminen/ohjelmistojen-testaus/issues/14
  it('Should keep its own value if already between limits at zero',() => {
    expect(clamp(0, -5, 5)).toEqual(0)
  })

  // Related issue https://github.com/TNieminen/ohjelmistojen-testaus/issues/14
  it('Should keep its own value if already between limits on the negative side',() => {
    expect(clamp(-1, -5, 5)).toEqual(-1)
  })
  ...
  it('Should return NaN with incorrect inputs null, undefined and NaN',() => {
